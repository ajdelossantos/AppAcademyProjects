class BSTNode
  ...
  def remove_val(value)
    ...
    # if value < @value && @left
    #   @left.remove_val(value)
    # elsif value > @value && @right
    #   @right.remove_val(value)
    # else
    #   if @left && @right
    #     @value = @left.get_max.value
    #     @left.remove_val(value)
    #   elsif @left # @left.parent == self
    #     @value = @left.get_max.value
    #     @left.remove_val(value)
    #     # @left.parent = @left.nil? ? @right : @left
    #   elsif @right # @right.parent == self
    #     @value = @right.get_max.value
    #     @right.remove_val(value)
    #     # @right.parent = @right.nil? ? @left : @right
    #   end
    # end
  end
